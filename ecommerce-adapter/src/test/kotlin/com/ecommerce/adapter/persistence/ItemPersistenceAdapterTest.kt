...
class ItemPersistenceAdapterTest @Autowired constructor(
    ...
    fun setUp() {
        val items = listOf(
            ItemEntity(1L, "test1", BigDecimal.valueOf(10000L), "http://test.png", Item.ItemStatus.SELLING, LocalDateTime.now(), LocalDateTime.now()),
            ItemEntity(1L, "test2", BigDecimal.valueOf(10000L), "http://test.png", Item.ItemStatus.SELLING, LocalDateTime.now(), LocalDateTime.now()),
            ItemEntity(1L, "test3", BigDecimal.valueOf(10000L), "http://test.png", Item.ItemStatus.SELLING, LocalDateTime.now(), LocalDateTime.now()),
            ItemEntity(1L, "test4", BigDecimal.valueOf(10000L), "http://test.png", Item.ItemStatus.SELLING, LocalDateTime.now(), LocalDateTime.now()),
            ItemEntity(1L, "test5", BigDecimal.valueOf(10000L), "http://test.png", Item.ItemStatus.SELLING, LocalDateTime.now(), LocalDateTime.now()),
        )
